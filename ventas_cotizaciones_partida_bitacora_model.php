...
class ventas_cotizaciones_partida_bitacora extends modelBase{
    ...
    public function save($userName){
        ...
        // guardamos
        $query = "call p_registraBitacora_Cotizacion_Partida($this->intTipoRegistro, $this->intCotizacion, $this->bytRevision, $this->intPartida, '$this->strDescripcion', '$userName', @result)";
	...
	public function getBitacoraCotizacion_Partida($intCotizacion, $bytRevision, $intPartida){
        ...
        $query = "SELECT 
                 ...
                 FROM view_cotizaciones_p_bitacora 
